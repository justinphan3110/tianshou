...
def get_args():
    ...
    parser.add_argument("--task", type=str, default="CoinrunEasy-v0")
    ...
    parser.add_argument("--frames-stack", type=int, default=3)
    ...
    parser.add_argument("--wandb-project", type=str, default="procgen.benchmark")
    parser.add_argument(
        "--watch",
        default=False,
        action="store_true",
...
def test_ppo(args=get_args()):
    env, train_envs, test_envs = make_procgen_env(
        args.task,
        args.seed,
        args.training_num,
        args.test_num,
    ...
    if args.resume_path:
        model = torch.load(args.resume_path, map_location=args.device)
        if 'model' in model:
            model = model['model']
